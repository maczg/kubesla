...
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=slos,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=slos/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=slos/finalizers,verbs=update
