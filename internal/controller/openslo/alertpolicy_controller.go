...
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=alertpolicies,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=alertpolicies/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=alertpolicies/finalizers,verbs=update
...
func (r *AlertPolicyReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&openslov1alpha1.AlertPolicy{}).
		Complete(r)
}
