...
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=slis,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=slis/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=slis/finalizers,verbs=update
