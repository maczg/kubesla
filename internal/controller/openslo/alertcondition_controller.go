...
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=alertconditions,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=alertconditions/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=openslo.kubesla.com,resources=alertconditions/finalizers,verbs=update
...
func (r *AlertConditionReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&openslov1alpha1.AlertCondition{}).
		Complete(r)
}
